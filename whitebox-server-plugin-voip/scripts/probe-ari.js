...
//     reads whitebox.config.js from the sibling whitebox-server checkout
//
...
async function loadConfig() {
  ...
  // 2. whitebox-server's config in the sibling repo.
  const cfgPath = path.resolve(__dirname, '../../whitebox-server/whitebox.config.js')

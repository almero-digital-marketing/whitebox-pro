...
Server side: enable `whitebox-server-plugin-crm`, which records observations into awareness as `channel:'crm', direction:'observation', source:'client'`.
